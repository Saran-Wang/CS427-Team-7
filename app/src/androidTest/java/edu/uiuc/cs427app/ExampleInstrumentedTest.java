...
public class ExampleInstrumentedTest {
    ...
    @Test
    public void C_addCity_sameActivity() {
        onView(withId(R.id.username)).perform(typeText("hmyu2"), closeSoftKeyboard());
        onView(withId(R.id.password)).perform(typeText("847B2m8c!"), closeSoftKeyboard());
        ...
        onView(ViewMatchers.withId(R.id.city_list))
                .perform((ViewAction) RecyclerViewActions.scrollTo(
                        hasDescendant(withText("Tokyo"))
                ));
        onView(ViewMatchers.withId(R.id.city_list))
                .perform((ViewAction) RecyclerViewActions.scrollTo(
                        hasDescendant(withText("Hong Kong"))
                ));
    }

    @Test
    public void F_deleteCity_sameActivity(){
        onView(withId(R.id.username)).perform(typeText("hmyu2"), closeSoftKeyboard());
        onView(withId(R.id.password)).perform(typeText("847B2m8c!"), closeSoftKeyboard());
    ...
    @Test
    public void D_testWeather_sameActivity() {
    ...
    @Test
    public void D1_testWeather_sameActivity() {
    ...
    @Test
    public void E_checkLatLon_sameActivity() {
        onView(withId(R.id.username)).perform(typeText("hmyu2"), closeSoftKeyboard());
        onView(withId(R.id.password)).perform(typeText("847B2m8c!"), closeSoftKeyboard());
    ...
    @Test
    public void E1_checkLatLon_sameActivity() {
        onView(withId(R.id.username)).perform(typeText("hmyu2"), closeSoftKeyboard());
        onView(withId(R.id.password)).perform(typeText("847B2m8c!"), closeSoftKeyboard());
